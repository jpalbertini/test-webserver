...
using GetDataCallback = std::function<QVariantMap(const ClientInformations&, const GetParameters&)>;
using PostDataCallback = std::function<QVariantMap(const ClientInformations&, const QVariantMap&)>;
